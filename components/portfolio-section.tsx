...
export function PortfolioSection() {
  const projects = [
    {
      title: "E-Commerce Transformation for Fashion Startup",
      description:
        "Helped a Delhi-based fashion brand build a complete e-commerce platform with automated inventory management, resulting in 3x sales growth in 6 months.",
      tag: "E-Commerce",
    ...
    {
      title: "Digital Marketing Success for Local Service Business",
      description:
        "Implemented comprehensive SEO and digital marketing strategy for a Mumbai service business, increasing leads by 250% and establishing strong online presence.",
