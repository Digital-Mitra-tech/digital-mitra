      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 pt-4 md:pt-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-[1.3]">
            ...
            <br />
            about <span className="bg-[#5C82A3] text-white px-3 py-1 inline-block">Digital Mitra</span>
          </h2>
            ...
            <div className="bg-white border-4 border-black rounded-3xl py-8 md:py-14 px-6 md:px-8 md:pr-72 lg:pr-72">
              ...
              <div className="md:max-w-[65%]">
                <p className="text-sm md:text-base lg:text-lg mb-6 leading-relaxed">
                  Digital Mitra transformed our entire online presence. Within 6 months, our e-commerce sales tripled,
                  and the automation solutions they implemented have saved us countless hours every week. Highly
                  recommended!
                </p>

                <div>
                  <div className="font-bold text-base md:text-lg">Priya Sharma</div>
                  <div className="text-gray-600 text-sm md:text-base">Founder, EthnicBazaar</div>
                </div>
              </div>
            </div>
