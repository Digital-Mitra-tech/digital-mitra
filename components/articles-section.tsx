    ...
    <section className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">Insights & Resources</h2>
          <Button
            variant="outline"
          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                Complete guide to building a successful e-commerce platform in India
              </h3>
              <div className="flex items-center gap-3 md:gap-4">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-[#5C82A3] border-2 border-black rounded-full overflow-hidden flex-shrink-0 flex items-center justify-center">
                  <span className="text-white font-bold">DM</span>
                </div>
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">Digital Mitra</div>
                  <div className="text-sm md:text-base text-gray-600">Dec 2024</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    10 SEO strategies to boost your online visibility in 2024
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Learn proven techniques to improve your website ranking and attract more Indian customers
                    organically
                  </p>
                </div>
              </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    How a traditional retail business scaled online
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Real story of transformation: From brick-and-mortar to successful multi-channel digital business
                  </p>
                </div>
              </div>
            </div>
